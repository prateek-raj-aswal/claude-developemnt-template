...
export default function BoardList() {
  ...
  async function handleCreate(name: string, description?: string | null, emoji?: string) {
    try {
      const board = await api.post<BoardResponse>('/api/v1/boards', { name, description: description ?? undefined, emoji })

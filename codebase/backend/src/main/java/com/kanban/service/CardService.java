...
public class CardService {
    ...
    public CardResponse updateCard(UUID cardId, UpdateCardRequest request, UUID requestingUserId) {
        ...
        if (request.startDate() != null) {
            java.time.LocalDate effectiveDueDate = request.dueDate() != null ? request.dueDate() : card.getDueDate();
            if (effectiveDueDate != null && request.startDate().isAfter(effectiveDueDate)) {
                throw new ApiException(HttpStatus.UNPROCESSABLE_ENTITY, "START_DATE_AFTER_DUE_DATE",

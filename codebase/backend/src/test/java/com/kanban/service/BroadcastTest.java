...
class BroadcastTest {
    ...
    void updateColumn_broadcastsColumnUpdated() {
        ...
        columnService.updateColumn(columnId, new UpdateColumnRequest("Renamed", null, null), userId);
    ...
    void updateColumn_colorChanged_broadcastsColumnColorUpdated() {
        ...
        columnService.updateColumn(columnId, new UpdateColumnRequest(null, "blue", null), userId);
    ...
    void updateColumn_nameAndColorChanged_broadcastsBothEventsInOrder() {
        ...
        columnService.updateColumn(columnId, new UpdateColumnRequest("Renamed", "blue", null), userId);
